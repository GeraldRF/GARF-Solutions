...
<div class="mis-servicios-container" data-spy="scroll" data-target="#main-navbar" data-offset="0">

    <div id="programacion" class="service-card">
    ...
    <div id="configuracion-hosting" class="service-card-blue">
        <div style="width: 100%; display: flex; flex-direction: row; justify-content: flex-end;">
            <div class="container-T-W elementRight">
        ...
        <div style="display: flex; flex-direction: row; flex-wrap: wrap; justify-content: center; gap:50px; margin-top:50px;">
            <div style="display: flex; flex-direction: column; align-items: center;">
                <h4 class="title-information-b" style="color:#fff; text-align: center;">Tipos de hosting utilizados</h4>
                <div style="display: flex; flex-direction: row; flex-wrap: wrap; justify-content: center; gap:20px">
                    ...
                    <div class="div-blanco">
                        ...
                        <h6>El rendimiento de estos tipos de hosting depende de la cantidad de paginas web de otras entidades con las que compartes el servidor. </h6>
                    </div>
                    <div class="div-blanco">
    ...
    <div id="instalacion-software" class="service-card">
        <div style="width: 100%; display: flex; flex-direction: row;">
            <div class="container-T-B elementLeft">
        ...
        <div style="display: flex; flex-direction: row; flex-wrap: wrap; justify-content: center; gap:50px; margin-top:50px;">
            <div style="display: flex; flex-direction: column; align-items: center;">
                <h4 class="title-information-w" style="color:#004698; text-align: center;">Instalación de programas como</h4>
                <img src="images/mis-servicios/instalacion-software/programas.svg" style="max-width: 90%;">
                <h6 style="color: red;">(Y más)</h6>
            </div>
            <div style="display: flex; flex-direction: column; align-items: center;">
                <h4 class="title-information-w" style="color:#004698; text-align: center;">Instalación de sistemas operativos</h4>
    ...
    <div id="mantenimiento-equipos" class="service-card-blue">
        <div style="width: 100%; display: flex; flex-direction: row; justify-content: flex-end;">
            <div class="container-T-W elementRight">
    ...
    <div id="instalacion-camaras" class="service-card-blue">
        <div style="width: 100%; display: flex; flex-direction: row; justify-content: flex-end;">
            <div class="container-T-W elementRight">
        ...
        <div style="display: flex; flex-direction: column; align-items: center; justify-content: center; gap:20px; margin-top:10px;">
            <h4 class="h5-green title-information-b">Tipos de conexiones</h4>
